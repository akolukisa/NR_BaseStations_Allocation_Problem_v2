...
def pbig_algorithm(sinr_matrix, max_iter=100, alpha=0.7, max_ues_per_beam=None):
    num_beams, num_ues = sinr_matrix.shape
...
def run_benchmark():
    print("="*70)
    print("4 BEAM BENCHMARK - MAX 4 UE/BEAM (Kapasite Kısıtlamalı)")
    print("="*70)
    ...
    bw_mhz = 100
    efficiency = 0.8
    max_capacity = 4  # Maximum UEs per beam
    ...
    # Save to CSV
    csv_file = 'results_4beam_10to100_cap4.csv'
